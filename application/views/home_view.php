  ...
  <section id="mu-slider">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="<?php echo base_url('assets/img/limpeza3.jpg'); ?>" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Bem-vindo a HomeHelp</h4>
        <span></span>
        <h2>Temos os melhores profissionais</h2>
        <p></p>
        <a href="#" class="mu-read-more-btn">Veja mais</a>
      </div>
    </div>
    <!-- Start single slider item -->
    <!-- Start single slider item -->
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="<?php echo base_url('assets/img/limpeza2.jpg'); ?>" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Diversos serviços</h4>
        <span></span>
        <h2>Atendemos a diversos serviços</h2>
        <p></p>
        <a href="#" class="mu-read-more-btn">Veja mais</a>
      </div>
    </div>
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="<?php echo base_url('assets/img/limpeza.jpg'); ?>" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Faça seu próprio horário</h4>
        <span></span>
        <h2>Personalize o seu horário de atendimento</h2>
        <p></p>
        <a href="#" class="mu-read-more-btn">Veja mais</a>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-left">
                  ...
                  <!-- End Title -->
                  <p>Somos a HomeHelp, trabalhamos com o foco em serviços domesticos para facilitar a sua vida.</p>
                  <ul>
                    <li>Faça seu próprio horario de atendimento.</li>
                    <li>Conte com um atendimento ético!</li>
                    <li>Um preço justo.</li>
                    <li>Realizamos atendementos seguros.</li>
                    <li>Qualidade de atendimento garantida.</li>
                  </ul>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-3">
                <div class="mu-abtus-counter-single no-border">
                  ...
                  <p>Certificados proffisionais</p>
                </div>
              </div>
              <!-- End counter item -->
            </div>
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4  col-sm-6">
                  <div class="mu-single-feature">
                    <span class="fa fa-book"></span>
                    <h4>Profissionais cursados</h4>
                    <p>Nossos profissionais tem ótima qualificação profissional para realizar todos os serviços demandados.</p>
                    <a href="#">Leia Mais</a>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                    <span class="fa fa-users"></span>
                    <h4>Experiencia na área</h4>
                    <p>Trabalhamos há mais de 5 anos no ramo, sendo a empresa pioneira em atendimento a domicilio de serviços domesticos.</p>
                    <a href="#">Leia Mais</a>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                    ...
                    <h4>Certificado Profissional</h4>
                    <p>Reconhecido pelo SINDOMESTICA como referencia no atendimento domiciliar.</p>
                    <a href="#">Leia Mais</a>
                  </div>
                </div>
              </div>
            ...
            <div id="mu-testimonial-slide" class="mu-testimonial-content">
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="assets/img/pessoa.jpg" alt="img">
                </div>
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="assets/img/pessoa2.jpg" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Stivenson Michel</h4>
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="assets/img/pessoa3.jpg" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Samantha Smith</h4>
                  <span>Happy Student</span>
                </div>
              </div>
              <!-- end testimonial single item -->
                ...
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    ...
                    <div class="mu-blog-description">
                      ...
                      <a class="mu-read-more-btn" href="#">Leia Mais</a>
                    </div>
                  </article>
                </div>
                <div class="col-md-4 col-sm-4">
